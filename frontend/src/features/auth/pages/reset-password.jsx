          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <ShieldCheck size={18} className="text-gray-500 group-focus-within:text-blue-400" />
              </div>
              <input
                type="text"
                maxLength={6}
                ...
                className="w-full bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-2xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-blue-500/50 font-bold tracking-widest text-center"
                required
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-2xl py-4 pl-12 pr-12 text-white focus:outline-none focus:border-blue-500/50"
                required
                minLength={8}
              />
              <button
