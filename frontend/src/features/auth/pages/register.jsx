...
import { Loader2, ArrowRight, Lock, Mail, User, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#030303] relative overflow-hidden px-4 selection:bg-brand-neon/30">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.04),transparent)] opacity-20 mix-blend-soft-light" />
      ...
      >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <User
                  size={18}
                  className="text-zinc-600 group-focus-within:text-brand-neon transition-colors"
                />
              </div>
              <input
                type="text"
        ...
        <p className="text-center mt-8 text-sm text-zinc-500">
          ...
          <Link
            to="/login"
            className="text-white hover:text-brand-neon font-medium transition-colors"
          >
            Sign in
          </Link>
        </p>
