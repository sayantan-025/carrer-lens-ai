...
import { ArrowRight, Mail, User, Eye, EyeOff, CheckCircle2, Check } from "lucide-react";
...
const Register = () => {
  ...
  // Validation States for Dopamine Feedback
  ...
  const ValidationCheck = ({ isValid }) => (
    <AnimatePresence>
      {isValid && (
        ...
        >
          <div className="bg-white rounded-full p-0.5 shadow-[0_0_10px_rgba(255,255,255,0.5)]">
            <Check className="size-3 text-black stroke-[4px]" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
        ...
        >
          ...
          <div className="space-y-4">
            <h2 className="text-5xl font-display font-bold text-white leading-[1.1] tracking-tighter">
              ...
              <span className="text-zinc-500">strategic superiority.</span>
            </h2>
            <p className="text-zinc-400 text-xl font-light leading-relaxed max-w-md">
              Create an account to unlock industrial-grade AI insights and master your professional trajectory.
            </p>
          </div>
          <div className="space-y-4">
            {[
              "Industrial AI Resume Analysis",
              "Strategic Interview Question Bank",
              "LaTeX-Inspired ATS Exports",
        ...
        >
          <div className="text-center lg:text-left mb-10">
            ...
            <p className="text-zinc-500 font-light text-sm">
              Initialize your account to begin the analysis.
            </p>
          </div>
            ...
            <LabelInputContainer>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-10 pr-4 flex items-center text-zinc-500 hover:text-white transition-colors z-20"
                >
              ...
              <p className={cn(
                "text-[10px] font-mono mt-2 tracking-tight transition-colors duration-300",
                isPasswordValid ? "text-zinc-400" : "text-zinc-600"
              )}>
