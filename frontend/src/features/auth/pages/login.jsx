  ...
  if (isAuthChecking) {
    return (
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 py-12 px-4 xs:px-6 text-left">
        ...
        <div className="w-full max-w-md bg-zinc-950/40 backdrop-blur-3xl border border-white/5 rounded-[2rem] xs:rounded-[2.5rem] p-6 xs:p-8 lg:p-10 shadow-2xl mx-auto lg:mr-0 relative h-auto min-h-[500px]">
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-6xl font-display font-bold text-white leading-[1.05] tracking-tighter">
            Welcome <br />
            <span className="text-zinc-500 text-6xl">Back.</span>
          </h2>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6 xs:space-y-8 flex flex-col items-center">
          <div className="w-full space-y-2 text-left">
            ...
            />
            {errors.email && (
              <p id="email-error" className="text-[10px] text-red-500 font-bold uppercase tracking-widest ml-1 animate-in fade-in slide-in-from-top-1">
                {errors.email}
              </p>
            )}
          </div>
          ...
          <div className="w-full space-y-2 text-left">
            <div className="flex justify-between items-center ml-1">
              <Label htmlFor="password" className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">Password</Label>
              <Link to="/forgot-password" size="sm" className="text-[9px] text-white/40 hover:text-white font-bold uppercase tracking-widest transition-colors">
                Forgot?
              </Link>
            </div>
            ...
            {errors.password && (
              <p id="password-error" className="text-[10px] text-red-500 font-bold uppercase tracking-widest ml-1 animate-in fade-in slide-in-from-top-1">
                {errors.password}
              </p>
            )}
          </div>
