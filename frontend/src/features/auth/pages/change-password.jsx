...
const ChangePassword = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden px-4 bg-black selection:bg-white/20 py-12">
      {/* Background Ambience */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <span className="flex items-center justify-center gap-2">
              {isLoading ? "Synchronizing..." : "Change Password"} <ArrowRight size={18} />
            </span>
            <BottomGradient />
          </button>
        </form>
